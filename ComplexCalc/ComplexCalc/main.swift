...
//let p3 = (-4, 4)
//let p4 = (0, 0)
//print(calc.add(lhs: p1, rhs: p2) == (17, -22))
//print(calc.subtract(lhs: p1, rhs: p2) == (-7, 32))
//print(calc.add(lhs: p4, rhs: p4) == (0, 0))
//print(calc.add(lhs: p3, rhs: p4) == (-4, 4))
//
//let pd1 = ["x": 5, "y": 5]
//let pd2 = ["x": -4, "y": 4]
//print(calc.add(lhs: pd1, rhs: pd2) == ["x": 1, "y": 9])
//print(calc.subtract(lhs: pd1, rhs: pd2) == ["x": 9, "y": 1])
//
